...
import com.drdisagree.iconify.core.utils.weather.WeatherContentProvider.Companion.WEATHER_AUTHORITY
...
class OmniJawsClient(private val mContext: Context) {
    ...
    companion object {
        ...
        val WEATHER_URI: Uri = "content://$WEATHER_AUTHORITY/weather".toUri()
        val SETTINGS_URI: Uri = "content://$WEATHER_AUTHORITY/settings".toUri()
        val CONTROL_URI: Uri = "content://$WEATHER_AUTHORITY/control".toUri()
