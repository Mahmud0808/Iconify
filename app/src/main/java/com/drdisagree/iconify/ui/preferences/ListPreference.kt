    ...
    private fun initResource(attrs: AttributeSet?) {
        ...
        attrs?.let {
            ...
            requiresSystemUiRestart =
                a.getBoolean(R.styleable.ListPreference_requiresSystemUiRestart, false)
            requiresDeviceRestart =
                a.getBoolean(R.styleable.ListPreference_requiresDeviceRestart, false)
            requiresThemeSwitch =
                a.getBoolean(R.styleable.ListPreference_requiresThemeSwitch, false)
            requiresDeviceRotation =
                a.getBoolean(R.styleable.ListPreference_requiresDeviceRotation, false)
            a.recycle()
        }
    }
