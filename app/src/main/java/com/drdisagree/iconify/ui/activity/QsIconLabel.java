...
public class QsIconLabel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SeekBarView.setCustomSeekbar(findViewById(R.id.move_icon), 8, 100, finalMoveIcon[0], new android.widget.SeekBar.OnSeekBarChangeListener() {
            @Override
        ...
        SeekBarView.setCustomSeekbar(findViewById(R.id.text_size), 10, 18, finalTextSize[0], new android.widget.SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onStartTrackingTouch(android.widget.SeekBar seekBar) {
            }
        ...
        SeekBarView.setCustomSeekbar(findViewById(R.id.icon_size), 0, 30, finalIconSize[0], new android.widget.SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onStartTrackingTouch(android.widget.SeekBar seekBar) {
            }
