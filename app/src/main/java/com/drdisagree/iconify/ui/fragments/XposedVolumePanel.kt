...
class XposedVolumePanel : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        // Show percentage
        binding.showPercentage.isSwitchChecked = getBoolean(VOLUME_PANEL_PERCENTAGE, false)
        binding.showPercentage.setSwitchChangeListener { _: CompoundButton?, isChecked: Boolean ->
