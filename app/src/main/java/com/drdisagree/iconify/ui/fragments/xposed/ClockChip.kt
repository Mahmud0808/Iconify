...
class ClockChip : BaseFragment() {
    ...
    private var customTextColorIndex: Int = getInt(STATUSBAR_CLOCK_COLOR_OPTION, 0)
    private var customTextColor: Int = getInt(STATUSBAR_CLOCK_COLOR_CODE, Color.WHITE)
    ...
    override fun onCreateView(
        ...
        binding.clockTextColor.setSelectedIndex(getInt(STATUSBAR_CLOCK_COLOR_OPTION, 0))
        ...
        binding.btnApply.setOnClickListener {
            RPrefs.apply {
                putInt(STATUSBAR_CLOCK_COLOR_OPTION, customTextColorIndex)
                putInt(STATUSBAR_CLOCK_COLOR_CODE, customTextColor)
