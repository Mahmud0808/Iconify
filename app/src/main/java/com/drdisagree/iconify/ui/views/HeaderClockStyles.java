    ...
    public static LinearLayout initHeaderClockStyle(Context mContext, int style) {
        ...
        switch (style) {
            case 1:
                ...
                clockMinute1.setTextColor(forceWhiteText ? mContext.getResources().getColor(R.color.white) : SystemUtil.getColorResCompat(mContext, android.R.attr.textColorPrimary));
                ...
                clockDay1.setTextColor(forceWhiteText ? mContext.getResources().getColor(R.color.white) : SystemUtil.getColorResCompat(mContext, android.R.attr.textColorPrimary));
                ...
                clockDate1.setTextColor(forceWhiteText ? mContext.getResources().getColor(R.color.white) : SystemUtil.getColorResCompat(mContext, android.R.attr.textColorPrimary));
            ...
            case 2:
                ...
                clock2.setTextColor(forceWhiteText ? mContext.getResources().getColor(R.color.white) : SystemUtil.getColorResCompat(mContext, android.R.attr.textColorPrimary));
                ...
                dayDate2.setTextColor(forceWhiteText ? mContext.getResources().getColor(R.color.white) : SystemUtil.getColorResCompat(mContext, android.R.attr.textColorPrimary));
            ...
            case 3:
                ...
                clock3.setTextColor(forceWhiteText ? mContext.getResources().getColor(R.color.white) : SystemUtil.getColorResCompat(mContext, android.R.attr.textColorPrimary));
                ...
                dayDate3.setTextColor(forceWhiteText ? mContext.getResources().getColor(R.color.white) : SystemUtil.getColorResCompat(mContext, android.R.attr.textColorPrimary));
            ...
            case 4:
                ...
                clockDate4.setTextColor(forceWhiteText ? mContext.getResources().getColor(R.color.white) : SystemUtil.getColorResCompat(mContext, android.R.attr.textColorPrimary));
            ...
            case 5:
                ...
                date5.setTextColor(forceWhiteText ? mContext.getResources().getColor(R.color.white) : SystemUtil.getColorResCompat(mContext, android.R.attr.textColorPrimary));
            ...
            case 6:
                ...
                mDrawable6.setCornerRadius((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, (RPrefs.getInt(UI_CORNER_RADIUS, 16) + 6) * mContext.getResources().getDisplayMetrics().density, mContext.getResources().getDisplayMetrics()));
