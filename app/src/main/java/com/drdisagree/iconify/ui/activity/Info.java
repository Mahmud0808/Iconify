...
public class Info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Translators section
        translators.add(new Object[]{"Faceless1999", getResources().getString(R.string.info_translators_fa), "https://github.com/Faceless1999", R.drawable.ic_user});
        translators.add(new Object[]{"Blays", getResources().getString(R.string.info_translators_ru), "https://github.com/B1ays", R.drawable.ic_user});
