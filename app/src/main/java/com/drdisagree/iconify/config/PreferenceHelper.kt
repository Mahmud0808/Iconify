...
class PreferenceHelper private constructor(@JvmField val mPreferences: ExtendedPrefs) {
    ...
    companion object {
        ...
        fun isVisible(key: String?): Boolean {
            return when (key) {
                "experimentalFeatures" -> instance.mPreferences.getBoolean(
                    "iconify_easter_egg",
                    false
                )
        ...
        fun getSummary(fragmentCompat: Context, key: String): String? {
            ...
            if (key.contains("Switch")) {
                return fragmentCompat.getString(
                    if (instance.mPreferences.getBoolean(
                            key,
                            false
                        )
            ...
            if (key.contains("MultiSelect")) {
                return instance.mPreferences.getStringSet(key, emptySet()).toString()
            }
                ...
                "IconifyAppLanguage" -> {
                    val currentLanguageCode =
                        listOf<String?>(*fragmentCompat.resources.getStringArray(R.array.locale_code))
                            .indexOf(
                                instance.mPreferences.getString(
                                    "IconifyAppLanguage",
