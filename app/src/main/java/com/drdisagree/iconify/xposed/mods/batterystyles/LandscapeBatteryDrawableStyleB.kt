...
open class LandscapeBatteryDrawableStyleB(private val context: Context, frameColor: Int) :
    BatteryDrawable() {
    ...
    companion object {
        private val TAG = LandscapeBatteryDrawableStyleB::class.java.simpleName
