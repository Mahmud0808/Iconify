...
open class LandscapeRBatteryDrawableStyleB(private val context: Context, frameColor: Int) :
    BatteryDrawable() {
    ...
    companion object {
        private val TAG = LandscapeRBatteryDrawableStyleB::class.java.simpleName
