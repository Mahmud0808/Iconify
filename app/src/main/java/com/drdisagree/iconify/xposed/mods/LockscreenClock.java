        ...
        if (showLockscreenClock) {
            switch (lockscreenClockStyle) {
                ...
                case 4:
                    ...
                    day4.setTextColor(customColorEnabled ? customColorCode : mContext.getResources().getColor(android.R.color.system_neutral1_200));
