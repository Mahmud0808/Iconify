...
public class LockscreenClock extends ModPack implements IXposedHookLoadPackage {
        ...
        if (showLockscreenClock) {
            switch (lockscreenClockStyle) {
                ...
                case 1:
                    ...
                    date1.setText(formatDate("EEEE, MMMM d", "EEEE d MMMM"));
                ...
                case 2:
                    ...
                    ((FrameLayout.LayoutParams) clockContainer2.getLayoutParams()).setMargins(0, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, -2 + lineHeight, mContext.getResources().getDisplayMetrics()), 0, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, -8 + lineHeight, mContext.getResources().getDisplayMetrics()));
                    ...
                    month2.setText(formatDate("MMMM d", "d MMMM"));
                ...
                case 3:
                    ...
                    date3.setText(formatDate("EEE, MMM dd", "EEE dd MMM"));
                ...
                case 4:
                    ...
                    day4.setText(formatDate("EEE, MMM dd", "EEE dd MMM"));
                ...
                case 7:
                    ...
                    date7.setText(formatDate("EEEE, MMM dd", "EEEE dd MMM"));
                ...
                case 8:
                    ...
                    date8.setText(formatDate("MMMM dd", "dd MMMM"));
    ...
    private String formatDate(String USformat, String EUformat) {
        try {
