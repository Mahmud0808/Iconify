        ...
        if (showHeaderClock) {
            ...
            switch (headerClockStyle) {
                case 1:
                    ...
                    GradientDrawable mDrawable1 = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{mContext.getResources().getColor(android.R.color.holo_blue_dark, mContext.getTheme()), mContext.getResources().getColor(android.R.color.holo_blue_dark, mContext.getTheme())});
                ...
                case 3:
                    ...
                    dayDateOverlay3.setTextColor(mContext.getResources().getColor(android.R.color.holo_blue_dark, mContext.getTheme()));
                ...
                case 5:
                    ...
                    GradientDrawable mDrawable5 = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{mContext.getResources().getColor(android.R.color.holo_blue_light, mContext.getTheme()), mContext.getResources().getColor(android.R.color.holo_blue_dark, mContext.getTheme())});
