...
public class HeaderClock extends ModPack implements IXposedHookLoadPackage {
    ...
    LinearLayout mQsHeaderClockLayout = null;
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) {
        ...
        addHeaderClockLayout();
        hideStockClockDate();
    }

    private void updateHeaderClock() {
        if (mQsHeaderClockLayout == null) return;
    ...
    private void addHeaderClockLayout() {
            ...
            ourResparam.res.hookLayout(SYSTEMUI_PACKAGE, "layout", "quick_status_bar_expanded_header", new XC_LayoutInflated() {
                ...
                public void handleLayoutInflated(LayoutInflatedParam liparam) {
                    ...
                    if (mQsHeaderClockLayout.getParent() != null) {
                        header.removeView(mQsHeaderClockLayout);
                    }

                    header.addView(mQsHeaderClockLayout);
                }
            });
        } catch (Throwable throwable) {
            log(TAG + throwable);
    ...
    private void loadHeaderClock() {
        ...
        mQsHeaderClockLayout.setVisibility(View.VISIBLE);
    }
