...
open class LandscapeBatteryDrawableiOS16(private val context: Context, frameColor: Int) :
    ...
    override fun draw(c: Canvas) {
        ...
        if (showPercent) {
            ...
            if (isNightMode(context)) textPaint.color = fillColor.inv() or 0xFF000000.toInt()
            else textPaint.color = fillColor.inv() or 0xFFFFFFFF.toInt()
    ...
    private fun isNightMode(context: Context): Boolean {
        return context.resources.configuration.uiMode and Configuration.UI_MODE_NIGHT_YES == Configuration.UI_MODE_NIGHT_YES
    }
